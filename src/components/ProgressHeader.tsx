...
export default function ProgressHeader({ summary }: { summary: DailySummary }) {
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <svg width="80" height="80" className="-rotate-90" style={{ flexShrink: 0 }}>
          ...
          <text x="40" y="40" textAnchor="middle" dominantBaseline="central"
            style={{ fontSize: 12, fontFamily: 'DM Sans', fontWeight: 600,
              transform: 'rotate(90deg)', transformOrigin: '40px 40px', fill: 'var(--ink)' }}>
